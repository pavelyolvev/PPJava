...
import Collections.*;
import Collections.Factories.FilmColFactory;
import Collections.Factories.ThColFactory;
import Supporting.*;
...
public class StreamMethods {
    ...
    public static CollectionMethods unmodifableColMethods(CollectionMethods o){
        return new unModCol(o);
    }
    private static ColMethodsFactory factoryFilm = new FilmColFactory();
    private static ColMethodsFactory factoryTh = new ThColFactory();
    public void setFactory(ColMethodsFactory fac){
        factoryFilm = fac;
        factoryTh = fac;

    }
    public static CollectionMethods createInstance(){
        return factoryFilm.createInstance();
    }
    public static CollectionMethods createInstance(String title, int credits, ArrayList<Integer> duration, boolean isFilm){
        if (isFilm){
            return factoryFilm.createInstance(title, credits, duration);
        }

        else return factoryTh.createInstance(title, credits, duration);
    }
}
